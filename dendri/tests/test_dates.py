...
class TestExtendSegments:
    ...
    @pytest.mark.parametrize(
        "df, group_col, start_dt_col, end_dt_col, tolerance, expected_output",
        [
            (input_df, "entity_id", "start_dt", "end_dt", 1, output_df),
            (input_df, ["entity_id"], "start_dt", "end_dt", 1, output_df),
            (input_df, ["entity_id", "iterator"], "start_dt", "end_dt", 1, input_df),
        ],
    )
...
class TestAge:
    input_df_static = (
        [("001", d("2004-02-28")), ("002", d("2004-02-29")), ("003", d("2004-03-01"))],
        ["entity_id", "birth_dt"],
    )

    output_df_feb28 = ([("001", 5), ("002", 5), ("003", 4)], ["entity_id", "age"])

    output_df_mar01 = ([("001", 5), ("002", 5), ("003", 5)], ["entity_id", "age"])

    output_df_feb28_leap = ([("001", 8), ("002", 7), ("003", 7)], ["entity_id", "age"])

    output_df_mar01_leap = ([("001", 8), ("002", 8), ("003", 7)], ["entity_id", "age"])
